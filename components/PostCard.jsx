  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <div className='block lg:flex text-center items-center justify-center pl-8 mb-8 w-full'>
        <div className='flex items-center justify-center mb-4 lf:mb-0 lf:w-auto mr-8'>
          <img 
        ...
        <div className='font-medium text-gray-700 mb-4 lf:mb-0 lf:w-auto mr-8'>
      ...
      <div className='text-center'>
          <Link href={`/post/${post.slug}`}>
              <span className='transition duration-500 transform hover:-translate-y-1 inline-block bg-purple-700 text-lg font-medium rounded-full text  -white px-8 py-3 cursor-pointer'>
                Continue Reading
              </span>
          </Link>
      </div>
